...
from ETrain.Models.MOVA.vision_experts.dinov2.modeling_dinov2 import Dinov2Model
from ETrain.Models.MOVA.vision_experts.vary.sam import build_sam_vit_b, build_sam_vit_h
from ETrain.Models.MOVA.vision_experts.codetr.vit import build_codetr_vit_l
import open_clip
import os
...
class MoVAVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        if self.is_loaded:
            ...
            return
        print("Setting up multiple vision tower.")
