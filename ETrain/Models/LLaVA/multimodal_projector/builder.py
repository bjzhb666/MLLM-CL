...
class MoVAdapter(nn.Module):
    def __init__(self, config):
        ...
        super().__init__()
        # config.topk_experts = 3
        # config.image_feat_size = 48
        # config.mm_projector_freeze_text_encoder=False
        ...
        # config.expert_channels = [1536, 512, 256, 1536, 768, 768, 256]
        self.expert_channels = expert_channels = config.expert_channels
        self.num_experts = len(expert_channels)
        # config.num_projector_layers = 3
