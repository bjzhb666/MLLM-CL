...
OUTPUT_DIR="./checkpoints/LLaVA/$BASE_NAME/APP_llava_lora_replay"
...
if [ ! $3 ]; then
    ...
    EXPERT="--expert_num $3"
    OUTPUT_DIR="./checkpoints/LLaVA/$BASE_NAME/APP_llava_lora_MOE_replay"
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --data_path $DATA_PATH/merged.json \
