...
if [ ! $2 ]; then
    ...
    PREVIOUS_TASK="--previous_task_model_path ./checkpoints/LLaVA/$BASE_NAME/OCR_llava_lora"
fi
if [ ! $3 ]; then
    EXPERT=""
else
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --data_path /data/hongbo_zhao/Ability_data/replay_json/task2replay30.json \
