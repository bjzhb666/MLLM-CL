...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --data_path /data2/rundongwang/data/tmp/Geo170K/train.json \
    --image_folder /data2/rundongwang/data/tmp/Geo170K \
    ...
    --bf16 True \
    --output_dir ./checkpoints/LLaVA/$BASE_NAME/Geo_llava_lora \
    --num_train_epochs 1 \
