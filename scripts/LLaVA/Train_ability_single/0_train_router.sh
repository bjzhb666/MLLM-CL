...
Train_Epoch=35
SAVE_DIR=./checkpoints/Router_Ability/task3-Router_llava_lora_5e-6-ep$Train_Epoch-sample20
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --data_path /data/hongbo_zhao/code/LLaVA/Ability_data/task3Router_train20.json \
    --image_folder /data/hongbo_zhao/code/LLaVA/Ability_data/num3sample_images20 \
