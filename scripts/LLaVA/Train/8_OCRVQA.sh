...
if [ ! $2 ]; then
    ...
    PREVIOUS_TASK="--previous_task_model_path ./checkpoints/LLaVA/$BASE_NAME/VQAv2_llava_lora"
fi
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --image_folder /data2/rundongwang/data/data/tmp \
    ...
    --bf16 True \
    --output_dir ./checkpoints/LLaVA/$BASE_NAME/OCRVQA_llava_lora \
    --num_train_epochs 1 \
