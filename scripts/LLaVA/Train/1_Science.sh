...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29100 ETrain/Train/LLaVA/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/LLaVA/$BASE_NAME/ScienceQA_llava_lora_128_3e-4 \
    --num_train_epochs 1 \
