...
# bash scripts/LLaVA/Eval_dom/2_eval_medical.sh Finetune "./checkpoints/LLaVA/Finetune-CL/Sci_llava_lora" Sci_med FineTune-CL-Test
...
# bash scripts/LLaVA/Eval_dom/2_eval_medical.sh Finetune "./checkpoints/LLaVA/Finetune-CL-MoE/Sci_llava_lora_MOE" Sci_med FineTune-CL-MoE-Test
